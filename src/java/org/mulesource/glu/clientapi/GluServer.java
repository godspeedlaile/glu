...
public class GluServer
{
    ...
    public HttpResult send(String url,
                           ...
                           HttpMethod method,
                           Integer status,
                           HashMap<String, String> headers) throws GluClientException
    {
        ...
        try {
            ...
            throw new GluClientException("Cannot connect with URI '" + fullUrl +
                                         "': " + e.getMessage());
        }
    }
     ...
     * @throws     GluClientException
     */
    public static String jsonSerialize(Object obj) throws GluClientException
    {
        try {
            ...
            throw new GluClientException("Could not serialize data: " + e.getMessage());
        }
    }
     ...
     * @throws     GluClientException
     */
    public static Object jsonDeserialize(String str) throws GluClientException
    {
        try {
            ...
            throw new GluClientException("Could not de-serialize data: " + e.getMessage());
        }
    }
     ...
     * @throws       GluClientException
     */
    protected HashMap<String, DescUriHolder> getDescUriMap(String uri) throws GluClientException
    {
     ...
     * @throws          GluClientException
     */
    public GluServer(String serverUri) throws MalformedURLException, GluClientException
    {
        ...
        if (!(url.getPath().isEmpty() || url.getPath().equals("/")) || url.getQuery() != null) {
            throw new GluClientException("No path or query allowed in server URI.");
        }

        if (!url.getProtocol().equals("http")) {
            throw new GluClientException("Only 'http' schema is currently supported.");
        }
        ...
        try {
            ...
            throw new GluClientException("Malformed server meta data: " + e.getMessage());
        }
     ...
     * @throws GluClientException
     */
    public String getServerDoc() throws GluClientException
    {
        if (doc == null) {
     ...
     * @throws  GluClientException
     */
    public HashMap<String, DescUriHolder> getAllResourceNamesPlus() throws GluClientException
    {
     ...
     * @throws  GluClientException
     */
    public String[] getAllResourceNames() throws GluClientException
    {
     ...
     * @throws  GluClientException
     */
    public HashMap<String, DescUriHolder> getAllComponentNamesPlus() throws GluClientException
    {
     ...
     * @throws  GluClientException
     */
    public String[] getAllComponentNames() throws GluClientException
    {
    ...
    /**
     * Return an initialized {@link GluComponent} object for the specified component.
     * 
     * @param  name   Name of the component.
     * @return        Initialized {@link GluComponent} object.
     * @throws        GluClientException 
     */
    public GluComponent getComponent(String name) throws GluClientException
    {
        ...
        return new GluComponent(this, (HashMap)res.data);
    }
    
    /**
     * Return an initialized {@link GluResource} object for the specified resource.
     * 
     * @param  name   Name of the resource.
     * @return        Initialized {@link GluResource} object.
     * @throws        GluClientException 
     */
    public GluResource getResource(String name) throws GluClientException
    {
        HttpResult res = jsonSend(resourceUri+"/"+name, null, null, 200, null);
        // The data of the HTTP result should be a dictionary with the component info
        return new GluResource(this, (HashMap)res.data);        
    }
}
